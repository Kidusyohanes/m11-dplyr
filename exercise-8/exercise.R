...
diff <- mutate(pulitzer, diff.2004.2013 = pulitzer$Daily.Circulation..2013 - pulitzer$Daily.Circulation..2004)

# What publication gained the most pulitzer prizes from 2004-2014?
# Be sure to use the pipe operator! 
most.pulitzer <- select(pulitzer,Pulitzer.Prize.Winners.and.Finalists..2004.2014) %>% filter(pulitzer, Pulitzer.Prize.Winners.and.Finalists..2004.2014 == max(Pulitzer.Prize.Winners.and.Finalists..2004.2014))

 #max(pulitzer$Pulitzer.Prize.Winners.and.Finalists..2004.2014)
